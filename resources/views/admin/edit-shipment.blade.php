...
<div class="edit-shipment-container">
    <div class="page-header">
        ...
        <p>Update shipment details and tracking information</p>
    </div>

    <div class="tracking-id-display">
        <i class="fas fa-barcode"></i> Tracking ID: {{ $shipment->tracking_id }}
    </div>
    ...
    <form method="POST" action="{{ route('admin.shipment.update', $shipment->id) }}" enctype="multipart/form-data" id="editShipmentForm" novalidate>
        @csrf
        @method('PUT')
        ...
        <div class="form-container">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sender_email" id="sender_email"
                               value="{{ old('sender_email', $shipment->sender_email) }}"
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <input type="text" class="form-control" name="sender_address" id="sender_address"
                               value="{{ old('sender_address', $shipment->sender_address) }}"
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label for="receiver_name" class="form-label">
                            <i class="fas fa-user"></i> Receiver Name
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="receiver_email" id="receiver_email"
                               value="{{ old('receiver_email', $shipment->receiver_email) }}"
                               placeholder="Enter email or 'ENCRYPTED' (Optional)"
                               autocomplete="off" autocorrect="off" spellcheck="false">
                        <div class="form-help">Enter a valid email, 'ENCRYPTED', or leave empty (Optional)</div>
                    </div>
                    <div class="form-group">
                        <label for="receiver_phone" class="form-label">
                            <i class="fas fa-phone"></i> Receiver Phone
                        </label>
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        <label for="receiver_address" class="form-label">
                            <i class="fas fa-map-marker-alt"></i> Receiver Address
                        </label>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="carrier" id="carrier">
                            ...
                            <option value="FEDEX Affiliate" {{ old('carrier', $shipment->carrier) == 'FEDEX Affiliate' ? 'selected' : '' }}>FEDEX Affiliate</option>
                            <option value="SHIPEX Express" {{ old('carrier', $shipment->carrier) == 'SHIPEX Express' ? 'selected' : '' }}>SHIPEX Express</option>
                            <option value="SHIPEX Standard" {{ old('carrier', $shipment->carrier) == 'SHIPEX Standard' ? 'selected' : '' }}>SHIPEX Standard</option>
                            <option value="SHIPEX Air" {{ old('carrier', $shipment->carrier) == 'SHIPEX Air' ? 'selected' : '' }}>SHIPEX Air</option>
                            <option value="SHIPEX Ground" {{ old('carrier', $shipment->carrier) == 'SHIPEX Ground' ? 'selected' : '' }}>SHIPEX Ground</option>
                            <option value="SHIPEX International" {{ old('carrier', $shipment->carrier) == 'SHIPEX International' ? 'selected' : '' }}>SHIPEX International</option>
                        </select>
                        <div class="form-help">Select the carrier service</div>
                    </div>
                    <div class="form-group">
                        <label for="carrier_reference_no" class="form-label">
                            <i class="fas fa-hashtag"></i> Carrier Reference No
                        </label>
                        <input type="text" class="form-control" name="carrier_reference_no" id="carrier_reference_no"
                               value="{{ old('carrier_reference_no', $shipment->carrier_reference_no) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="expected_delivery_date" id="expected_delivery_date"
                               value="{{ old('expected_delivery_date', $shipment->expected_delivery_date) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" class="form-control" name="delivery_time" id="delivery_time"
                               value="{{ old('delivery_time', $shipment->delivery_time) }}">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label for="status" class="form-label">
                            <i class="fas fa-flag"></i> Current Status <span class="required-indicator">*</span>
                        </label>
                        <input type="text" class="form-control" name="status" id="status"
                               value="{{ old('status', $shipment->status) }}" required
                               placeholder="Enter current status (e.g., In Transit, Delivered, Custom)">
                        <div class="form-help">Enter any custom current status for the shipment</div>
                    </div>
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <textarea class="form-control" name="status_message" id="status_message" rows="4"
                                  placeholder="Enter detailed status message (Optional)">{{ old('status_message', $shipment->status_message) }}</textarea>
                        <div class="form-help">Detailed message about the current status</div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="file-upload-area" onclick="document.getElementById('image').click()">
                    ...
                    <label for="image" class="form-label" style="cursor: pointer; margin: 0;">
                        <strong>Choose Package Image</strong>
                        <br>
                    ...
                    @if($shipment->image_path)
                        <div class="current-image">
                            ...
                            <a href="{{ asset('storage/' . $shipment->image_path) }}" target="_blank">
                                View Current Package Image
                            </a>
                        </div>
                    @endif
                </div>
            ...
            <div class="action-buttons">
                ...
                <a href="{{ route('admin.shipment-list') }}" class="btn btn-secondary">
